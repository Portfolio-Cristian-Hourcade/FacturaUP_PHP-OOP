<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header" style="background-color: grey;">
			...
			<h2 class="modal-title" style="color:white;">Nuevo Cliente</h2>
		</div>
		<div class="modal-body">
			...
			<div class="col-md-6"><input type="password" id="contrasena"></div>
			<br><br>
			...
			<div class="modal-footer">
				<center>
				<button class="btn btn-lg btn-info clientes-nuevo">Añadir</button>
				</center>
			</div>
		</div>
