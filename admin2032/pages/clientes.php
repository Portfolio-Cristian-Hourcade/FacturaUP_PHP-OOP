                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <button type="button" class="btn btn-md btn-danger btn-borrar-clientes">Borrar</button>
                            <button type="button" class="btn btn-md btn-warning btn-editar-clientes">Editar</button>
                            <br><br>
